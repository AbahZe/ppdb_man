...
<?php } ?>
	...
	<?php if ($formulir->status_anak=='Ya'){ ?>			
		<tr>
		    <td>Status Anak</td>
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->status_anak ?></td>
		</tr>
	<?php } ?>
...
<!-- 	<?php if ($formulir->no_kip=='Ya'){ ?>			
	...
	<?php if ($formulir->no_seri_ijazah_sd=='Ya'){ ?>		
		<tr>		    
		    <td>No. Seri Ijazah SD</td>
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->no_seri_ijazah_sd ?></td>
		</tr>
	<?php } ?>
	<!--END TAMBAHAN-->
