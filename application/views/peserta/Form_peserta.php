...
<!-- end pilihan jurusan -->                                                     
                          ...
                          <?php } ?>                          
                           <!-- TAMBAHAN -->
                        <?php if ($formulir->no_seri_ijazah_sd=='Ya'){ ?>
                            <div class="form-group">
                                  <label for="varchar">No Seri Ijazah SD <span style="color:red;">*</span><?php echo form_error('no_seri_ijazah_sd') ?></label>
                                  <input type="text" class="form-control" name="no_seri_ijazah" id="no_seri_ijazah_sd" placeholder="No Seri Ijazah SD" value="<?php echo $no_seri_ijazah_sd; ?>" required/>
                            </div>
                          <?php } else { ?>
                                <input type="hidden" class="form-control" name="no_seri_ijazah_sd" id="no_seri_ijazah_sd" />
                          <?php } ?>       
                        <!-- END TAMBAHAN -->
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseThree" class="panel-collapse collapse">
                    <div class="box-body">
                          ...
                          <div class="form-group">
                                <label for="varchar">No KK <span style="color:red;">*</span> <?php echo form_error('no_kk') ?></label>
                                <input type="text" class="form-control" name="no_kk" id="no_kk" placeholder="No KK harus tepat 16 karakter" required/>
                          </div>
                          <?php } else { ?>
                          ...
                          <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kabko" id="kabko" placeholder="kabko" required/>
                          </div>
                          <?php } else { ?>
                          ...
                          <div class="form-group">
                                <label for="varchar">Selama Sekolah Tinggal Dengan <span style="color:red;">*</span> <?php echo form_error('tempat_tinggal') ?></label>
