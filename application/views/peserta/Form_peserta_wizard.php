...
<!-- end pilihan jurusan -->                                                       
                          ...
                          <?php if ($formulir->no_seri_ijazah_sd=='Ya'){ ?>
                            <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="no_seri_ijazah_sd" id="no_seri_ijazah_sd" placeholder="No Seri Ijazah SD" value="<?php echo $no_seri_ijazah_sd; ?>" required/>
                            </div>
                          <?php } else { ?>
