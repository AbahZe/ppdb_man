    ...
    <div class="col-xs-12 col-md-12">
        <div class="box box-primary">
            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <div class="form-group">
                    <label for="varchar">Selama Sekolah Tinggal Dengan <?php echo form_error('tempat_tinggal') ?></label>
                <?php if ($button=="Tambah") { ?>     
...
<!-- end pilihan jurusan -->                
                ...
                <div class="form-group">
                    <label for="varchar">No Seri Ijazah SD<?php echo form_error('no_seri_ijazah_sd') ?></label>
                    <input type="text" class="form-control" name="no_seri_ijazah_sd" id="no_seri_ijazah_sd" placeholder="No Seri Ijazah SD" value="<?php echo $no_seri_ijazah_sd; ?>" />
                </div>
                <?php } else { ?>
