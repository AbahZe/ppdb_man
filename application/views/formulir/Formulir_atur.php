                  ...
                  <div class="col-xs-12 col-md-4">
                    ...
                    <div class="row">                     
                      <div class="col-xs-12 col-md-3"> 
                        ...
                        <div class="form-group">                       
                          <input type="checkbox" name="no_seri_ijazah_sd" id="no_seri_ijazah_sd" value="Ya" <?php if ($formulir->no_seri_ijazah_sd=='Ya') { echo 'checked'; } ?>>&nbsp; No Seri Ijazah SD
                        </div> 
                      ...
                      <div class="col-xs-12 col-md-3">                    
                        ...
                        <div class="form-group">                      
                          <input type="checkbox" name="no_kk" id="no_kk" value="Ya" <?php if ($formulir->no_kk=='Ya') { echo 'checked'; } ?>>&nbsp; No KK
                        </div>
                        <div class="form-group">                      
                        ...
                        <div class="form-group">                      
                          <input type="checkbox" name="tempat_tinggal" id="tempat_tinggal" value="Ya" <?php if ($formulir->tempat_tinggal=='Ya') { echo 'checked'; } ?>>&nbsp; Selama Sekolah Tinggal Dengan  
                        </div>
                        <div class="form-group">                      
