...
class Peserta extends CI_Controller
{
    ...
    {  	
	    ...
	    if ($row) {
	        $data = array(
				...
				'no_seri_ijazah_sd' => $row->no_seri_ijazah_sd,
    ...
    public function create()
    {
	    $data = array(
			...
			'no_seri_ijazah_sd' => set_value('no_seri_ijazah_sd'),
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
				...
				'no_seri_ijazah_sd' => $this->input->post('no_seri_ijazah_sd',TRUE),
    ...
    public function update($id)
    {
	    ...
	    if ($row) {
	        $data = array(
				...
				'no_seri_ijazah_sd' => set_value('no_seri_ijazah_sd', $row->no_seri_ijazah_sd),
	...
	$this->form_validation->set_rules('no_seri_ijazah_sd', 'no seri ijazah_sd', 'trim');
    ...
    public function excel()
    {
		...
		xlsWriteLabel($tablehead, $kolomhead++, "Selama Sekolah Tinggal Dengan");
		...
		xlsWriteLabel($tablehead, $kolomhead++, "No Seri Ijazah SD");
	...
	foreach ($this->Peserta_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->no_seri_ijazah_sd);
